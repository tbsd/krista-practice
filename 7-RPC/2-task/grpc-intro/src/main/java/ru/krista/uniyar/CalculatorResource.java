...
public class CalculatorResource {
    ...
    public String hello(@QueryParam("n1") Double number1, @QueryParam("n2") Double number2, @QueryParam("op") Integer operation) {
        ...
        CalculatorProto.CalculatorResponse response = client.calculate(CalculatorProto.CalculatorRequest.newBuilder().setNumber1(number1).setNumber2(number2)
                .setOperationValue(operation).build());
